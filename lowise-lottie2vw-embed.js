...
(function() {
  ...
  const lottieSettings = {
    ...
    width: config.lottieWidth || "100vw",     // Para estilo Lottie y base para sizeForFlowise
    height: config.lottieHeight || "100vw",   // Para estilo Lottie
  ...
  function createLottieElement() {
    ...
    Object.assign(lottieBtn.style, {
      ...
      position: "fixed",
      bottom: lottieSettings.bottom + "vw", // lottieSettings.bottom es número, se añade "vw"
      right: lottieSettings.right + "vw",   // lottieSettings.right es número, se añade "vw"
      cursor: "pointer",
      zIndex: "10000"
    });
