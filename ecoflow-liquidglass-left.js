// Contenido para flowise-lottie3.2-embed.js - VERSION IZQUIERDA
(function() {
    'use strict';
    ...
    const config = {
        ...
        lottieButtonLeft: getConfig(currentScript, 'lottieButtonLeft', '20px'), // CAMBIADO: left en lugar de right
        ...
        // Theme -> Button (original ECO button) - POSICIÓN IZQUIERDA
        themeButtonBackgroundColor: getConfig(currentScript, 'themeButtonBackgroundColor', '#3B81F6'),
        themeButtonLeft: getConfig(currentScript, 'themeButtonLeft', 20, 'number'), // CAMBIADO: left en lugar de right
    ...
    function mainInit() {
        ...
        lottieButtonElement.style.left = config.lottieButtonLeft; // CAMBIADO: left en lugar de right
        ...
        import('https://cdn.jsdelivr.net/npm/flowise-embed/dist/web.js')
            .then(module => {
                ...
                Chatbot.init({
                    ...
                    theme: {
                        button: {
                            ...
                            left: config.themeButtonLeft, // CAMBIADO: left en lugar de right
                ...
                /* POSICIONAMIENTO IZQUIERDO PARA LA VENTANA DEL CHAT */
                flowise-chatbot {
                    --flowise-chatwindow-left: 20px !important;
                    --flowise-chatwindow-right: auto !important;
                }

                /* Ventana del chat posicionada a la izquierda */
                .chatbot-container {
